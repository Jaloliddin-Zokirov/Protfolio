...
const WORDS = ["Digital Experience Creator", "Web Development Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Material-UI", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Jaloliddin-Zokirov" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/jaloliddin-zokirov-4869b0276" },
  { icon: Instagram, link: "https://www.instagram.com/jaloliddinzokirov_" }
];
